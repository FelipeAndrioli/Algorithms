				...
				if(verifica_entrada(retorno_entrada_user) == 2) {
					...
					for(;;) {
						...
						if(verifica_entrada(retorno_entrada_user) == 2) {
							...
							//tree->raiz = insertTreeElement(tree->raiz, elemento);
							insertTreeNode(tree, elemento);
							break;
						}
					}
				} else if(opcao == 2) {
					if(tree->raiz == NULL) {
						...
						for(;;) {
							...
							if(verifica_entrada(retorno_entrada_user) == 2) {
								...
								searchTreeElement(tree, elemento);
							}
						}
					}
				} else if(opcao == 3) {
